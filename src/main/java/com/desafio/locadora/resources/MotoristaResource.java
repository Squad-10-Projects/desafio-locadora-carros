...
import com.desafio.locadora.services.MotoristaService;
...
public class MotoristaResource {
    ...
    @Operation(
            description = "Exibe ao usuário todos os aluguéis relacionados ao seu id",
            summary = "Exibe os aluguéis do usuário")
